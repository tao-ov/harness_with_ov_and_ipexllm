...
models.MODEL_REGISTRY['ipex-llm'] = IPEXLLM    # patch ipex-llm to harness, use IPEXLLM.create_from_arg_string to obtain models
models.MODEL_REGISTRY['openvino'] = OPENVINO   # add openvino to harness
logging.getLogger("openai").setLevel(logging.WARNING)

import lm_eval
import ipexllm
print(lm_eval.__file__)
print("=== IPEXLLM in: ", ipexllm.__file__)
